...
export default function IntroBanner(props) {
  return (
    <div className='intro-banner'>
      <div className='container flex flex_row section intro-banner-contents'>
        <IntroText />
        <IntroTileList />
      </div>
    </div>
...
function IntroText(props) {
  return (
    <div className='intro-text flex flex_column flex_center-vertical'>
      <h1 className="intro-text-header">New to user scripts?</h1>
      <p id="intro-text-tagline">Ever frustrated with an annoying design issue on a website? <br />A user script may help!</p>
      <p id="intro-text-cta">Click on the buttons to the right to get started!</p>
    </div>
  )
}
